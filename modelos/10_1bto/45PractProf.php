...
public function eliminar($carnet)
{
  ...
  global $PracticaProf;
  $sql = "UPDATE notas SET EVA1P1='',EVA2P1='',EVA3P1='',EVA4P1='',EVA5P1='',NRP1='',EVA1P2='',EVA2P2='',EVA3P2='',EVA4P2='',EVA5P2='',NRP2='',EVA1P3='',EVA2P3='',EVA3P3='',EVA4P3='',EVA5P3='',NRP3='',EVA1P4='',EVA2P4='',EVA3P4='',EVA4P4='',EVA5P4='',NRP4='',NRFINAL='',NOTAFINAL='' WHERE carnet='$carnet' AND idmaterias='$PracticaProf' ";
    return ejecutarConsulta($sql);
...
FROM alumnos a INNER JOIN notas N ON N.carnet=a.carnet AND N.carnet='$carnet' AND a.idgrado='$gradS' AND N.idmaterias='$PracticaProf'
";
...
ON N.carnet=a.carnet AND N.idmaterias=ma.idmaterias AND a.estado='1' AND a.idgrado='$gradS' AND N.idmaterias='$PracticaProf'";
