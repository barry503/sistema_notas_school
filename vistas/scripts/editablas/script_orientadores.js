...
/*para editar los datos*/$("#formulario").on("submit",function(e)
  ...
  $.post("../ajax/editablas/Ajax_Orientadores.php?op=selectDocentes", function(re){
             $("#iddocentes").html(re);
 ...
 //Cargamos los items al select de grados
  $.post("../ajax/editablas/Ajax_Orientadores.php?op=selectGrado", function(r){
             $("#idgrado").html(r);
            ...
            "ajax":
                    {
                         ...
                         url: "../ajax/editablas/Ajax_Orientadores.php?op=listar",
                         type : "get",
                         dataType : "json",
                         error: function(e){
...
function guardaryeditar(e)
{
     ...
     $.ajax({
         url:"../ajax/editablas/Ajax_Orientadores.php?op=guardaryeditar",
         type: "POST",
         data: formData,
         contentType: false,
         processData: false,
...
function mostrar(id)
{
   $.post("../ajax/editablas/Ajax_Orientadores.php?op=mostrar",{id : id}, function(data, status)
    {
...
function eliminar(id)
{
  ...
  bootbox.confirm("Esta seguro de eliminar el Orientador ?", function(result) {

      if(result)
      {
       $.post("../ajax/editablas/Ajax_Orientadores.php?op=eliminar", {id : id}, function(e){
         bootbox.alert(e);
         // tabla.ajax.reload();
              listar();
         // setTimeout('document.location.reload()'); //para recargar la pajina web (provicional) 
