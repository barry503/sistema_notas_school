            ...
            "ajax":
                    {
                         ...
                         url: "../ajax/"+CarpetaDelGrado+"/4Aestso.php?op=listar",
                         type : "get",
                         dataType : "json",
                         error: function(e){
...
function guardaryeditar(e)
{
     ...
     $.ajax({
         url:"../ajax/"+CarpetaDelGrado+"/4Aestso.php?op=guardaryeditar",
         type: "POST",
         data: formData,
         contentType: false,
         processData: false,
...
{
   $.post("../ajax/"+CarpetaDelGrado+"/4Aestso.php?op=mostrar",{carnet : carnet}, function(data, status)
    {
...
function eliminar(carnet)
{
  ...
  bootbox.confirm("Esta seguro de eliminar las notas del alumno ?", function(result) {
      ...
      if(result)
      {
       $.post("../ajax/"+CarpetaDelGrado+"/4Aestso.php?op=eliminar", {carnet : carnet}, function(e){
         bootbox.alert(e);
         // tabla.ajax.reload();
              listar();
