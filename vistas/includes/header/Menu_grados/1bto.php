...
<li class="nav-item has-treeview">
 ...
 <?php 
              ...
              if(!empty($_SESSION['conducta'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="C1bto.php" class="nav-link">
...
<!-- materias basicas -->
 ...
 <?php 
              ...
              if(!empty($_SESSION['LENGUAJE'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="1bto1len.php" class="nav-link">
...
<?php } ?>
 ...
 <?php 
              ...
              if(!empty($_SESSION['MATEMATICAS'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="1bto2mate.php" class="nav-link">
...
<?php } ?>
 ...
 <?php 
              ...
              if(!empty($_SESSION['CIENCIAS_FÍSICAS'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="1bto3cifi.php" class="nav-link">
...
<?php } ?>
 ...
 <?php 
              ...
              if(!empty($_SESSION['ESTUDIOS_SOCIALES'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="1bto4estso.php" class="nav-link">
...
<?php } ?>              
 ...
 <?php 
              ...
              if(!empty($_SESSION['INGLES'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="1bto8ingles.php" class="nav-link">
...
<?php } ?> 
 ...
 <?php 
              ...
              if(!empty($_SESSION['EDUCACION_FISICA'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="1bto6edufis.php" class="nav-link">
...
<?php } ?> 
 ...
 <?php 
              ...
              if(!empty($_SESSION['INFORMATICA'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="1bto7infor.php" class="nav-link">
...
<!-- materias Asignaturas  -->
 ...
 <?php 
              ...
              if(!empty($_SESSION['SEMINARIO'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="1bto5semi.php" class="nav-link">
...
<?php } ?> 
 ...
 <?php 
              ...
              if(!empty($_SESSION['TECNOLOGIA'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="1bto9tecno.php" class="nav-link">
...
<?php } ?> 
 ...
 <?php 
              ...
              if(!empty($_SESSION['QUÍMICA_Y_BIOLOGÍA'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="1bto10quiybio.php" class="nav-link">
...
<?php } ?> 
 ...
 <?php 
              ...
              if(!empty($_SESSION['ORIENTACION_PARA_LA_VIDA'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="1bto11opv.php" class="nav-link">
...
<?php 
              ...
              if(!empty($_SESSION['FORMACION_CRISTIANA'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="1bto13forcris.php" class="nav-link">
...
<?php 
              ...
              if(!empty($_SESSION['MORAL_URBANIDAD_Y_CIVICA'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="1bto17MoralYUrCi.php" class="nav-link">
                  <i class="fas    fa-fire nav-icon"></i>
...
<?php 
              ...
              if(!empty($_SESSION['PRESUPUESTO'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="1bto14presu.php" class="nav-link">
...
<?php 
              ...
              if(!empty($_SESSION['COMERCIALIZACION'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="1bto15comer.php" class="nav-link">
...
<?php 
              ...
              if(!empty($_SESSION['CONTABILIDAD_DE_COSTO'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="1bto16contacos.php" class="nav-link">
...
<?php 
              ...
              if(!empty($_SESSION['PRACTICA_PROFECIONAL'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="1bto45PractProf.php" class="nav-link">
