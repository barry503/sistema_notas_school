...
<!-- materias basicas -->
 ...
 <?php 
              ...
              if(!empty($_SESSION['LENGUAJE'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="8_1len.php" class="nav-link">
...
<?php } ?>
 ...
 <?php 
              ...
              if(!empty($_SESSION['MATEMATICAS'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="8_2mate.php" class="nav-link">
...
<?php } ?>
 ...
 <?php 
              ...
              if(!empty($_SESSION['CIENCIAS_FÍSICAS'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="8_3cifi.php" class="nav-link">
...
<?php } ?>
 ...
 <?php 
              ...
              if(!empty($_SESSION['ESTUDIOS_SOCIALES'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="8_4estso.php" class="nav-link">
...
<?php } ?>              
 ...
 <?php 
              ...
              if(!empty($_SESSION['INGLES'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="8_8ingles.php" class="nav-link">
...
<?php } ?> 
 ...
 <?php 
              ...
              if(!empty($_SESSION['EDUCACION_FISICA'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="8_6edufis.php" class="nav-link">
...
<?php } ?> 
 ...
 <?php 
              ...
              if(!empty($_SESSION['INFORMATICA'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="8_7infor.php" class="nav-link">
...
<!-- materias Asignaturas  -->
 ...
 <?php 
              ...
              if(!empty($_SESSION['SEMINARIO'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="8_5semi.php" class="nav-link">
...
<?php } ?> 
 ...
 <?php 
              ...
              if(!empty($_SESSION['TECNOLOGIA'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="8_9tecno.php" class="nav-link">
...
<?php } ?> 
 ...
 <?php 
              ...
              if(!empty($_SESSION['QUÍMICA_Y_BIOLOGÍA'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="8_10quiybio.php" class="nav-link">
...
<?php } ?> 
 ...
 <?php 
              ...
              if(!empty($_SESSION['ORIENTACION_PARA_LA_VIDA'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="8_11opv.php" class="nav-link">
...
<?php 
              ...
              if(!empty($_SESSION['FORMACION_CRISTIANA'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="8_13forcris.php" class="nav-link">
...
<?php 
              ...
              if(!empty($_SESSION['MORAL_URBANIDAD_Y_CIVICA'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="8_17MoralYUrCi.php" class="nav-link">
                  <i class="fas    fa-fire nav-icon"></i>
...
<?php 
              ...
              if(!empty($_SESSION['PRESUPUESTO'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="8_14presu.php" class="nav-link">
...
<?php 
              ...
              if(!empty($_SESSION['COMERCIALIZACION'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="8_15comer.php" class="nav-link">
...
<?php 
              ...
              if(!empty($_SESSION['CONTABILIDAD_DE_COSTO'])==1)
             {
              ?>
 <li class="nav-item">
                <a href="8_16contacos.php" class="nav-link">
