        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3 style="font-size: 40px"><?php echo $grados; ?><sup style="font-size: 27px"><i class="far fa-dot-circle nav-icon"></i></sup></h3>

                <p>Total de  grados disponibles</p> <br>
              </div>
              <div class="icon">
...
<div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <div class="inner">
                ...
                <p>Alumnos sin registro de Asistencias</p><br>
              </div>
              <div class="icon">
