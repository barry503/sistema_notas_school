     ...
     <div class="row mb-2">
            <div class="col-md-6 text-muted">
              <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <input type="hidden" name="iddocentes" id="iddocentes">
             
                <input type="text" class="form-control" name="nombre" id="nombre" maxlength="50" placeholder="nombre del docente" required>
           ...
           <div class="col-md-6 text-muted">
              <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <input type="text" class="form-control" name="apellido" id="apellido" maxlength="50" placeholder="apellidos del docente" required>
...
<script  src="scripts/editablas/script_docentes.js"></script>
