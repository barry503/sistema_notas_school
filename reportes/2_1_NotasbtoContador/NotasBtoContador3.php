...
#variables a traer de VistaNotasXgrado.php
  include 'NotasBtoContador3/vYv.php'; 
?>
...
<?php 
/*ESTA INCLUSION TRAE CONSULTAS FIJAS*/ include 'NotasBtoContador3/ConsultasInstitucion.php'; 
?>

<!-- APARTADO DE VARIABLES DE ACTIVIDADES X PERIODO -->
     <?php 
      include 'NotasBtoContador3/4NombrandoVariablesXperiodo.php';
     ?>
...
include 'NotasBtoContador3/idMaterias.php'; 
?>
...
<?php 
include 'NotasBtoContador3/TablaDeNotas.php'; ?>
