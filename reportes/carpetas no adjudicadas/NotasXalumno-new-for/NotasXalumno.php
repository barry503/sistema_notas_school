...
include 'include/idMaterias.php'; 
?>
...
/*______________________________Empiesa las personalizaciones de las tablas_______________________________________*/        
...
/*________________________________________Empiesan las comparaciones entre tablas_________________________________________*/	    
	    ON x.idsexo=a.idsexo /* comparacion entre sexo y alumnos*/
	    AND g.idgrado=a.idgrado /* comparacion entre grado y alumnos*/
        AND a.carnet='$alumno' /* comparacion entre alumnos y Variable grado*/
	    AND o.iddocentes=d.iddocentes /*comparacion entre orientadores y docentes*/
	    AND o.idgrado=a.idgrado /*comparacion entre orientadores y Variable grado*/
...
/*ESTA INCLUSION TRAE CONSULTAS FIJAS*/ include 'include/ConsultasInstitucion.php'; 
