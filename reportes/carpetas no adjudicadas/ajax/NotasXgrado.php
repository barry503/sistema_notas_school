...
<div class="py-5 " >
              ...
              <table class="table table-striped table-bordered  table-condensed   text-black  table-hover text-center">
                ...
                <thead><tr>
                  <th colspan="2" rowspan="2"><img  width="180px" height="200px" src="../files/img/AdminLTELogo.png"></td></th>
...
Swal.fire({
                       icon:'success',
                       title:'Alumno de <?php  echo utf8_encode($Agrado); ?>.',
                         html: '<p>Consulta exitosa </p>',
                          grow: 'fullscreen',
                       footer: 'Nota: baja un poco para ver los resultados. <br>Para imprimir los resultados pulsa el boton Imprimir'
                   });
