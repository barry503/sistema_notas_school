...
<head>
  <meta charset="utf-8">
  <title>Bachillerato Contador|Boletas de Notas | <?php echo $AInstitucion; ?> </title>
...
<?php   $query_Alumnos=$base->query("SELECT idgrado, nombre_grado FROM grado  WHERE idgrado >=10 AND idgrado <=12  ")->fetchAll(PDO::  FETCH_OBJ);
...
<!-- fila para todas las targetas -->
 <div class="row" id="imprimirDatosConta">
