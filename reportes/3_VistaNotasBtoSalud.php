...
<head>
  <meta charset="utf-8">
  <title>Ballicherato Salud|Boletas de Notas | <?php echo $AInstitucion; ?> </title>
...
<!-- <link rel="stylesheet" type="text/css" href="bootstrap/css/bootstrap.min.css"> -->
 <!-- Theme style -->
  ...
  <link rel="stylesheet" type="text/css" href="bootstrap-temas/Minty/bootstrap.min.css">
...
<?php   $query_Alumnos=$base->query("SELECT idgrado, nombre_grado 
  FROM grado /*Tabla*/
  WHERE idgrado >=13 /*Donde el idgrado sea mayor o igual a 12*/")->fetchAll(PDO::  FETCH_OBJ);
...
<!-- fila para todas las targetas -->
 <div class="row" id="imprimirlosdatos">
