...
include 'Notas1Salud/1.btosalud.idMaterias.php'; 
?>
    ...
    <table border="8"   class="table table-striped table-bordered  table-condensed   text-black  table-hover text-center">
      ...
      <!-- <thead> -->
        ...
        <tr>
         ...
         <td><?php echo $s1M1odulo;  ?></td> 
         <td><?php echo $s1M2odulo;  ?></td> 
         <td><?php echo $s1M3odulo;  ?></td> 
         <td><?php echo $s1M4odulo;  ?></td> 
         <td><?php echo $s1M5odulo;  ?></td>
         <td><?php echo $s1M6odulo;  ?></td>
         <td><?php echo $s1M7odulo;  ?></td>
         <td><?php echo $s1M8odulo;  ?></td> 
...
<?php  include 'Notas1Salud/renombroASaVariable.php';  ?>
