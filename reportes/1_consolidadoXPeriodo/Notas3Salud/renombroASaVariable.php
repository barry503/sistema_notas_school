...
#13 ORIENTACION VOCACIONAL
   $OrientacionVocacional= $tds18->OrientacionVocacional;
   $OVnota1= $tds18->OVnota1;
   $OVnota2= $tds18->OVnota2;
   $OVnota3= $tds18->OVnota3;
   $OVnota4= $tds18->OVnota4;
   $OVnota5= $tds18->OVnota5;
   $OVnotaRecu= $tds18->OVnotaRecu;

   $S18=$OVnota1 * $p1+$OVnota2 * $p2 + $OVnota3 * $p3 + $OVnota4 * $p4 + $OVnota5 * $p5;
