...
include 'Notas3Salud/3.btosalud.idMaterias.php'; 
?>
    ...
    <table border="8"   class="table table-striped table-bordered  table-condensed   text-black  table-hover text-center">
      ...
      <!-- <thead> -->
        ...
        <tr>
          ...
          <th><?php echo $OrientacionVocacional; ?></th>
...
<?php  include 'Notas3Salud/renombroASaVariable.php';  ?>
