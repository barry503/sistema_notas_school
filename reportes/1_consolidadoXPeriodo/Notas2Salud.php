...
include 'Notas2Salud/2.btosalud.idMaterias.php'; 
?>
    ...
    <table border="8"   class="table table-striped table-bordered  table-condensed   text-black  table-hover text-center">
      ...
      <!-- <thead> -->
        ...
        <tr>
          ...
          <th colspan="6">
            Grado: <?php echo utf8_encode($Agrado); ?>
          </th>
        ...
        <tr>
          ...
          <th><?php echo $lenguaje; ?></th>
          <th><?php echo $matematicas; ?></th>
          <th><?php echo $ciencias; ?></th>
          <th><?php echo $sociales; ?></th>
          <th><?php echo $seminario; ?></th>
          <th><?php echo $EducacionFisica; ?></th>
          <th><?php echo $Informatica; ?></th>
          <th><?php echo $Ingles; ?></th>



          <th><?php echo $OPV; ?></th>
          <th><?php echo $FormacionCristiana; ?></th>

         <td><?php echo $s2M1odulo;  ?></td> 
         <td><?php echo $s2M2odulo;  ?></td> 
         <td><?php echo $s2M3odulo;  ?></td> 
         <td><?php echo $s2M4odulo;  ?></td> 
         <td><?php echo $s2M5odulo;  ?></td>
         <td><?php echo $s2M6odulo;  ?></td>
         <td><?php echo $s2M7odulo;  ?></td>
         <td><?php echo $s2M8odulo;  ?></td> 
...
<?php  include 'Notas2Salud/renombroASaVariable.php';  ?>
  
 
 <!-- AQUI VA LA TABLA  DE DATOS PARA NOTAS DEL ALUMNO -->
     <?php 
     //include 'Notas1Salud/4.TablaNotas.php'; 
     ?>
