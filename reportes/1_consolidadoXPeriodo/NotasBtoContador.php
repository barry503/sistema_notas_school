...
include 'NotasBtoContador/idMaterias.php'; 
?>
    ...
    <table border="8"   class="table table-striped table-bordered  table-condensed   text-black  table-hover text-center">
      ...
      <!-- <thead> -->
        ...
        <tr>
          ...
          <th><?php echo $quimicaYbiologia; ?></th>
          <th><?php echo $OPV; ?></th>
          <th><?php echo $laboCreatividad; ?></th>
          <th><?php echo $FormacionCristiana; ?></th>
          <th><?php echo $presupuesto; ?></th>
          <th><?php echo $comercializacion; ?></th>
          <th><?php echo $contabilidadDeCostos; ?></th>
          <th><?php echo $PracticaProfesional; ?></th>
...
<?php  include 'NotasBtoContador/renombroASaVariable.php';  ?>
  

<!-- AQUI VA LA TABLA  DE DATOS PARA NOTAS DEL ALUMNO -->
<?php 
//include 'NotasBtoContador/TablaDeNotas.php'; ?>
