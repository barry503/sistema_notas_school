...
<!-- <link rel="stylesheet" type="text/css" href="bootstrap/css/bootstrap.min.css"> -->
 <!-- Theme style -->
  ...
  <link rel="stylesheet" type="text/css" href="bootstrap-temas/Unido/bootstrap.min.css">
...
<?php   $query_Alumnos=$base->query("SELECT idgrado, nombre_grado FROM grado WHERE idgrado <=6  ")->fetchAll(PDO::  FETCH_OBJ);
...
<!-- fila para todas las targetas -->
 <div class="row" id="imprimirDatosBasica1A6">
