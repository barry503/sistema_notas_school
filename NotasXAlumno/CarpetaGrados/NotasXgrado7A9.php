...
#variables a traer de VistaNotasXgrado.php
  include 'NotasXgrado7A9/vYv.php'; 
?>
...
<?php 
/*ESTA INCLUSION TRAE CONSULTAS FIJAS*/ include 'NotasXgrado7A9/ConsultasInstitucion.php'; 
?>

<!-- APARTADO DE VARIABLES DE ACTIVIDADES X PERIODO -->
     <?php 
      include 'NotasXgrado7A9/4NombrandoVariablesXperiodo.php';
     ?>
